...
<body style="margin:5px;">
	...
	fit="true" url="gradeList" toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="dig" class="easyui-dialog" style="width:400px;height:280px;padding:10px 20px;"
	 closed="true" buttons="#dig-buttons">
		<form id="fm" method="post">
			<table>
			<tr>
				<td>班级名称：</td>
				<td><input type="text" name="gradeName" id="gradeName" class="easyui-validatebox" required/></td>
			</tr>
			<tr>
				<td value="top">班级描述：</td>
	...
	<div id="dig-buttons">
		...
		<a href="javascript:closeGradeDialog()" class="easyui-linkbutton" iconCls="icon-ok">关闭</a>
	</div>
</body>
</html>