...
<script type="text/javascript" src="jquery-easyui-1.3.3/locale/easyui-lang-zh_CH.js"></script>
...
var url;
	...
	function deleteStudent(){
		...
		var ids=strIds.join(",");
		$.messager.confirm("系统提示","确定要删掉这<font color=red>"+selectedRows.length+"</font>条数据么？",function(r){
			if(r){
...
<body style="marigin:5px;">
<table id="dg" title="学生信息" class="easyui-datagrid" 
	fitColumns="true" pagination="true" rownumbers="true" 
	fit="true" url="studentList" toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="tb">
		...
		&nbsp;出生日期：&nbsp;<input type="text" class="easyui-datebox" id="s_bbirthday" name="s_bbirthday" editable="false" size="10">->
		<input type="text" class="easyui-datebox" id="s_ebirthday" name="s_ebirthday"  editable="false" size="10">
		&nbsp;所属班级：&nbsp;<input class="easyui-combobox" id="s_gradeId" name="s_gradeId" editable="false" size="10" data-options="valueField:'id',textField:'gradeName',url:'gradeComboList'" panelHeight="auto"/>
		<a href="javascript:searchStudent()" class="easyui-linkbutton" iconCls="icon-search" plain="true">搜索</a></div>
	</div>
	
	<div id="dig" class="easyui-dialog" style="width:580px;height:350px;padding:10px 20px;"
	 closed="true" buttons="#dig-buttons">
		<form id="fm" method="post">
			<table cellspacing="5px;">
			<tr>
				<td>学号：</td>
				<td><input type="text" name="stuNo" id="stuNo" class="easyui-validatebox" required/></td>
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td>姓名：</td>
				<td><input type="text" name="stuName" id="stuName" class="easyui-validatebox" required/></td>
			</tr>
			<tr>
				<td>性别：</td>
				...
				<td></td>
				<td>出生日期：</td>
				<td><input type="text" class="easyui-datebox" id="birthday" name="birthday" editable="false" size="10" required ></td>
			</tr>
			<tr>
				<td>所属班级：</td>
				<td><input class="easyui-combobox" id="gradeId" name="gradeId" editable="false" size="10" data-options="valueField:'id',textField:'gradeName',url:'gradeComboList'" panelHeight="auto"/></td>
				<td></td>
				<td>Email：</td>
				<td><input type="text" name="email" id="email" class="easyui-validatebox" required validType="email"/></td>
			</tr>
			<tr>
				<td value="top">学生备注：</td>
